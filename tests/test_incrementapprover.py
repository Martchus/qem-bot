...
def fake_package_diff(mocker: MockerFixture) -> None:
    # assume the package "foo" has changed for x86_64 only (so additional_builds will only lead to an addtional build on x86_64)
...
def prepare_approver_with_additional_config(
